...
- (BOOL)azIsSameWeekAsDate:(NSDate *) aDate;
...
@property(nonatomic, readonly) NSInteger azHour;
...
@property(nonatomic, readonly) NSInteger firstDayOfWeekday;
@property(nonatomic, readonly) NSInteger lastDayOfWeekday;
// e.g. 2nd Tuesday of the month == 2
@property(nonatomic, readonly) NSInteger nthWeekday;
@property(nonatomic, readonly) NSInteger year;
@property(nonatomic, readonly) NSInteger gregorianYear;
@end
